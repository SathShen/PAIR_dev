...
def add_maskformer2_config(cfg):
    ...
    cfg.MODEL.MASK_FORMER.SIZE_DIVISIBILITY = 1
    ...
    cfg.INPUT.MIN_PIXEL = 3136
    cfg.INPUT.MAX_PIXEL = 390000
    ...
    cfg.INPUT.FRAME_LEFT = 7
    cfg.INPUT.FRAME_RIGHT = 7
    cfg.INPUT.SAMPLING_FRAME_NUM = 15
    cfg.INPUT.SIZE_DIVISIBILITY = 1

    cfg.MODEL.SUPERVISE_SPARSE = False
    cfg.TEST.EVAL_SPARSE = False
    cfg.MODEL.OPEN_VOCAB = True
...
def add_maskformer2_video_config(cfg):
    ...
    cfg.INPUT.SAMPLING_FRAME_NUM = 15
    cfg.MODEL.DECODER_3D = True
    cfg.TEST.EVAL_3D = True
    cfg.INPUT.INPAINT_DEPTH = True
    ...
    cfg.INPUT.VOXEL_SIZE = [0.05, 0.05]
    ...
    cfg.FEATURE_DIR = "/path/to/scannet_image_qwen_features"
    ...
    cfg.MODEL.MASK_FORMER.TRAIN_NUM_POINTS_2D = cfg.MODEL.MASK_FORMER.TRAIN_NUM_POINTS
    cfg.INPUT.FRAME_LEFT_2D = 0
    cfg.INPUT.FRAME_RIGHT_2D = 0
    cfg.INPUT.SAMPLING_FRAME_NUM_2D = 1
    ...
    cfg.USE_AUTO_NOUN_DETECTION = True

    cfg.WANDB_PROJECT = "qwen3d"
    cfg.DETACH_GENERATION_LOSS = False
    cfg.USE_NEW_EVAL_METRICS_FORMAT = True

    # box loss configs
    cfg.USE_BOX_LOSS = False
    cfg.MODEL.MASK_FORMER.BOX_WEIGHT = 0.0 
    cfg.MODEL.MASK_FORMER.GIOU_WEIGHT = 0.0
    ...
    cfg.FORCE_VIT_XYZ_SCALE = True
    cfg.MULTIVIEW_XYZ_SCALES = [28, 7]
    ...
    cfg.WANDB_ENTITY = "katef_odin"
    cfg.AR_LLM = False
    cfg.AR_EMBED = False
    cfg.AR_INSTRUCT = False

    cfg.FREEZE_QWEN = False
    cfg.DISABLE_ANCHOR = False
    cfg.SOLVER.AMP.DTYPE = "bfloat16"  # "bfloat16" or "float16"
    cfg.SOLVER.LR_SCHEDULER_NAME = "warmupconstantlr"
    ...
    cfg.DATASETS.TRAIN = (
        "sr3d_ref_scannet_train_single",
        "scanrefer_scannet_anchor_train_single",
        "nr3d_ref_scannet_anchor_train_single",
    ...
    cfg.PSEUDO_2D_TO_3D_AUG = False
    cfg.NORMALIZE_PC = False
    cfg.DUPLICATE_SAMPLING = None
    cfg.GEN_KWARGS = CN()
    cfg.GEN_KWARGS.max_new_tokens = 128 # TODO: maybe set this to None,  I have this to 128 atm because all the experiments are with 128
    cfg.GEN_KWARGS.temperature = 1e-06
    cfg.GEN_KWARGS.top_p = 1.0
    cfg.GEN_KWARGS.num_beams = 1
    cfg.GEN_KWARGS.do_sample = True
    cfg.QA_GROUND_LOSS = False
    cfg.USE_LORA = True
    cfg.LORA_RANK = 8
    cfg.LORA_ALPHA = 16
