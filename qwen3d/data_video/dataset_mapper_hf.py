...
import numpy as np
import math
from .data_utils import round_by_factor, floor_by_factor, ceil_by_factor, qwen_preprocess_frames
...
class HFDatasetMapper:
    ...
    def __call__(self, dataset_dict):
        ...
        pv_list, grid_list = qwen_preprocess_frames(
            self._qwen_image_processor, output_dict["images"]
        )
        output_dict["qwen_pixel_values"] = pv_list
        output_dict["qwen_grid_thw"] = grid_list
        return output_dict